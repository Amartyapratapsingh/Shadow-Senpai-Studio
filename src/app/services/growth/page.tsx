...
const SERVICES = [
  {
    ...
    title: "PR Campaigns",
    description:
      "Get featured on blogs, forums, and social media. Build your brand authority.",
  ...
  },
  {
    ...
    description:
      "Increase likes, comments, shares, and watch time through organic strategies.",
  ...
  },
  {
    ...
    description:
      "Targeted ad campaigns to reach your ideal audience fast.",
  ...
  },
  {
    ...
    description:
      "Rank higher in YouTube search with keyword research, tags, and descriptions.",
  ...
  },
  {
    ...
    description:
      "Monthly performance reports with actionable insights to improve.",
      ...
      <main className="flex-1">
        ...
        <div className="relative">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 50% at 50% 10%, rgba(16, 185, 129, 0.12) 0%, rgba(10, 120, 80, 0.06) 40%, transparent 70%)",
            }}
          />
          ...
          <section className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
            ...
            <div className="text-center mb-16">
              <p className="text-emerald-500 text-xs font-bold uppercase tracking-[0.3em] mb-3">
                GROWTH & MARKETING
              </p>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
                Growth & <span className="text-emerald-500">Marketing</span>
              </h1>
              <p className="text-white/50 text-lg max-w-xl mx-auto leading-relaxed">
                Scale your channel with proven strategies and services.
              </p>
            </div>
          </section>
        ...
        <section className="relative py-20 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 0%, rgba(16,185,129,0.3) 20%, rgba(16,185,129,0.5) 50%, rgba(16,185,129,0.3) 80%, transparent 100%)",
            }}
          />

          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
              className="relative rounded-2xl p-10 sm:p-14 overflow-hidden border border-emerald-500/20 text-center"
              style={{
                background:
                  "linear-gradient(160deg, rgba(16,185,129,0.08) 0%, rgba(255,255,255,0.02) 50%, rgba(16,185,129,0.04) 100%)",
              }}
            >
              <div
                className="absolute inset-0"
              ...
              <div className="relative">
                ...
                <p className="text-white/50 text-sm sm:text-base mb-8 max-w-md mx-auto">
                  Data-driven strategies, proven results. Get a custom growth plan for your channel.
                </p>
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 px-7 py-3 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-sm transition-all hover:scale-105 shadow-lg shadow-emerald-600/25"
                >
