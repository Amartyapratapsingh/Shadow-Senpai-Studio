...
const SERVICES = [
  {
    ...
    title: "Video Editing",
    description:
      "Professional editors who understand anime/manhwa style. Quick turnaround, cinematic transitions, sound design.",
  ...
  },
  {
    ...
    description:
      "Full channel management including uploads, SEO, thumbnails, scheduling, analytics.",
  ...
  },
  {
    ...
    description:
      "Data-driven growth plans, niche analysis, content calendar, trend research.",
  ...
  },
  {
    ...
    description:
      "1-on-1 sessions with growth experts. Audit your channel, fix what's broken, scale what works.",
  ...
  },
  {
    ...
    description:
      "Eye-catching thumbnails designed for maximum CTR. A/B tested designs.",
  ...
  },
  {
    ...
    description:
      "Professional scriptwriters for manhwa recaps, anime reviews, and web novel narrations.",
      ...
      <main className="flex-1">
        ...
        <div className="relative">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 50% at 50% 10%, rgba(239, 68, 68, 0.12) 0%, rgba(180, 20, 20, 0.06) 40%, transparent 70%)",
            }}
          />
          ...
          <section className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
            ...
            <div className="text-center mb-16">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
                Creator <span className="text-red-500">Services</span>
              </h1>
              <p className="text-white/50 text-lg max-w-xl mx-auto leading-relaxed">
                Professional support for content creators at every stage.
              </p>
            </div>
          </section>
        ...
        <section className="relative py-20 overflow-hidden">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 70% 50% at 50% 50%, rgba(239, 68, 68, 0.06) 0%, transparent 70%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 0%, rgba(239,68,68,0.3) 20%, rgba(239,68,68,0.5) 50%, rgba(239,68,68,0.3) 80%, transparent 100%)",
            }}
          />

          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
              className="relative rounded-2xl p-10 sm:p-14 overflow-hidden border border-red-500/20 text-center"
              style={{
                background:
                  "linear-gradient(160deg, rgba(239,68,68,0.08) 0%, rgba(255,255,255,0.02) 50%, rgba(239,68,68,0.04) 100%)",
              }}
            >
              <div
                className="absolute inset-0"
                style={{
                  background:
                    "radial-gradient(ellipse at center, rgba(239,68,68,0.10) 0%, transparent 70%)",
                }}
              />
              <div className="relative">
                ...
                <p className="text-white/50 text-sm sm:text-base mb-8 max-w-md mx-auto">
                  Let our team of experts help you build, grow, and scale your
                  content creation career.
                </p>
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 px-7 py-3 rounded-lg bg-red-600 hover:bg-red-700 text-white font-semibold text-sm transition-all hover:scale-105 shadow-lg shadow-red-600/25"
                >
